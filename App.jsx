...
const worldHeritageDataPart1 = [
  ...
  { id:"avignon", name:"アヴィニョン歴史地区―教皇宮殿・司教建造物群及びアヴィニョン橋",
    ...
    image:"https://images.unsplash.com/photo-1533595806096-b42abd89a67b?w=400",
  ...
  { id:"potsdam", name:"ポツダムとベルリンの宮殿群と公園群",
    ...
    image:"https://images.unsplash.com/photo-1527824404775-dce343a5ccc5?w=400",
  ...
  { id:"dubrovnik", name:"ドゥブロヴニクの旧市街", nameEn:"Old City of Dubrovnik",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Dubrovnik_Stradun_1.jpg",
  ...
  { id:"cesky_krumlov", name:"チェスキー・クルムロフ歴史地区", nameEn:"Historic Centre of Český Krumlov",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Cesky_Krumlov_Castle_05.jpg",
  ...
  { id:"vienna", name:"ウィーン歴史地区", nameEn:"Historic Centre of Vienna",
    ...
    image:"https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=400",
  ...
  { id:"krakow", name:"クラクフ歴史地区", nameEn:"Cracow's Historic Centre",
    ...
    image:"https://images.unsplash.com/photo-1562611054-c4a2a4be18b2?w=400",
  ...
  { id:"cologne_area", name:"ライン渓谷中上流域", nameEn:"Upper Middle Rhine Valley",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Loreley_01.jpg",
  ...
  { id:"bath", name:"バース市街", nameEn:"City of Bath",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Roman_Baths,_Bath_2006.jpg",
  ...
  { id:"bruges", name:"ブルッヘ歴史地区", nameEn:"Historic Centre of Brugge",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Belfort_Bruges.jpg",
  ...
  { id:"toledo", name:"トレドの歴史都市", nameEn:"Historic City of Toledo",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Toledo_-_Panoramio.jpg",
  ...
  { id:"mont_blanc", name:"ピレネー山脈―ペルデュ山", nameEn:"Pyrénées - Mont Perdu",
    ...
    image:"https://images.unsplash.com/photo-1526711657229-e7e080ed7aa1?w=400",
  ...
  { id:"taishan", name:"泰山", nameEn:"Mount Taishan",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Mount_Tai_from_Yuhuang_Summit.jpg",
  ...
  { id:"jiuzhaigou", name:"九寨溝の自然景観と歴史地区",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Jiuzhaigou_valley.jpg",
  ...
  { id:"suzhou", name:"蘇州古典園林", nameEn:"Classical Gardens of Suzhou",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Master_of_the_Nets_Garden.jpg",
  ...
  { id:"ellora", name:"エローラ石窟群", nameEn:"Ellora Caves",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Kailash_Temple_at_Ellora.jpg",
  ...
  { id:"khajuraho", name:"カジュラーホーの寺院群", nameEn:"Khajuraho Group of Monuments",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Khajuraho_Kandariya_Mahadeva_temple.jpg",
  ...
  { id:"prambanan", name:"プランバナン寺院遺跡群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Prambanan_temple_compound.jpg",
  ...
  { id:"hoi_an", name:"ホイアンの古い町並み", nameEn:"Hoi An Ancient Town",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Hoi_An_ancient_town.jpg",
  ...
  { id:"ayutthaya", name:"アユタヤの歴史都市", nameEn:"Historic City of Ayutthaya",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ayutthaya_Ruin.jpg",
  ...
  { id:"samarkand", name:"サマルカンド－文化の交差路",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Registan_Samarkand.jpg",
  ...
  { id:"gyeongju", name:"慶州歴史地域", nameEn:"Gyeongju Historic Areas",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Cheomseongdae_observatory.jpg",
  ...
  { id:"changdeokgung", name:"昌徳宮", nameEn:"Changdeokgung Palace Complex",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Changdeokgung_Secret_Garden.jpg",
  ...
  { id:"luang_prabang", name:"ルアン・パバンの町", nameEn:"Town of Luang Prabang",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Luang_Prabang_from_Phousi_Hill.jpg",
  ...
  { id:"bagan", name:"バガン", nameEn:"Bagan",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Bagan_Myanmar.jpg",
  ...
  { id:"persepolis", name:"ペルセポリス", nameEn:"Persepolis",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Persepolis_Apadana_Staircase.jpg",
  ...
  { id:"sukhothai", name:"スコータイと周辺の歴史都市群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Sukhothai_Wat_Mahathat.jpg",
  ...
  { id:"mohenjo_daro", name:"モヘンジョ・ダロの遺跡", nameEn:"Archaeological Ruins at Moenjodaro",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Mohenjo-daro_Sindh.jpg",
...
const japanHeritageData = [
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Kinkakuji3.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Iwami_Ginzan_Silver_Mine.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Tomioka_Silk_Mill.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/National_Museum_of_Western_Art01s3200.jpg",
...
const worldHeritageDataPart2 = [
  ...
  { id:"pyramids", name:"メンフィスとその墓地遺跡", nameEn:"Memphis and its Necropolis",
    ...
    image:"https://images.unsplash.com/photo-1539650116574-8efeb43e2750?w=400", youtubeQuery:"ギザ ピラミッド 世界遺産", keywords:["ピラミッド","エジプト","古代","スフィンクス","七不思議"] },
  { id:"abu_simbel", name:"ヌビアの遺跡群－アブ・シンベルからフィラエまで", nameEn:"Nubian Monuments from Abu Simbel to Philae",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Abu_Simbel_Front.jpg", youtubeQuery:"アブシンベル ラムセス2世 世界遺産", keywords:["アブシンベル","エジプト","ラムセス","移設","ヌビア"] },
  { id:"goree", name:"ゴレ島", nameEn:"Island of Gorée",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ゴレ島 奴隷 セネガル 世界遺産", keywords:["ゴレ島","奴隷","セネガル","負の遺産","大西洋"] },
  { id:"timbuktu", name:"ティンブクトゥ", nameEn:"Timbuktu",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Djingareyber_Mosque_Timbuktu.jpg", youtubeQuery:"ティンブクトゥ マリ 砂漠 世界遺産", keywords:["ティンブクトゥ","マリ","砂漠","イスラム","交易"] },
  { id:"great_zimbabwe", name:"グレート・ジンバブエの遺跡", nameEn:"Great Zimbabwe National Monument",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Great_Zimbabwe_-_The_Great_Enclosure.JPG", youtubeQuery:"グレートジンバブエ 石造 世界遺産", keywords:["ジンバブエ","石造","ショナ","アフリカ","城塞"] },
  { id:"victoria_falls", name:"モシ・オ・トゥニャ/ヴィクトリアの滝", nameEn:"Mosi-oa-Tunya / Victoria Falls",
    ...
    image:"https://images.unsplash.com/photo-1541956064527-8ec6f8a3f93c?w=400", youtubeQuery:"ヴィクトリア滝 アフリカ 世界遺産", keywords:["ヴィクトリア滝","アフリカ","滝","ザンビア","ジンバブエ"] },
  { id:"serengeti", name:"セレンゲティ国立公園", nameEn:"Serengeti National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Serengeti_NP.jpg", youtubeQuery:"セレンゲティ ヌーの大移動 タンザニア 世界遺産", keywords:["セレンゲティ","タンザニア","ヌー","大移動","サバンナ"] },
  { id:"ngorongoro", name:"ンゴロンゴロ保全地域", nameEn:"Ngorongoro Conservation Area",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ngorongoro_Crater.jpg", youtubeQuery:"ンゴロンゴロ カルデラ タンザニア 世界遺産", keywords:["ンゴロンゴロ","カルデラ","タンザニア","人類化石","野生動物"] },
  { id:"lalibela", name:"ラリベラの岩窟教会群", nameEn:"Rock-Hewn Churches, Lalibela",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Bete_Giyorgis_Lalibela.jpg", youtubeQuery:"ラリベラ 岩窟教会 エチオピア 世界遺産", keywords:["ラリベラ","エチオピア","岩窟教会","キリスト教","中世"] },
  { id:"robben_island", name:"ロベン島", nameEn:"Robben Island",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Robben_Island.jpg", youtubeQuery:"ロベン島 マンデラ アパルトヘイト 世界遺産", keywords:["ロベン島","南アフリカ","マンデラ","アパルトヘイト","島"] },
  { id:"kilimanjaro", name:"キリマンジャロ国立公園", nameEn:"Kilimanjaro National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Kilimanjaro.jpg", youtubeQuery:"キリマンジャロ アフリカ最高峰 世界遺産", keywords:["キリマンジャロ","タンザニア","アフリカ最高峰","火山","雪"] },
  { id:"okavango", name:"オカバンゴ・デルタ", nameEn:"Okavango Delta",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Okavango_Aerial_1.jpg", youtubeQuery:"オカバンゴ デルタ ボツワナ 世界遺産", keywords:["オカバンゴ","ボツワナ","デルタ","野生動物","象"] },
  { id:"djenne", name:"ジェンネの旧市街", nameEn:"Old Towns of Djenné",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Great_Mosque_of_Djenné_1.jpg", youtubeQuery:"ジェンネ 泥モスク マリ 世界遺産", keywords:["ジェンネ","マリ","泥建築","モスク","イスラム"] },
  // ══ 中東 ══
  { id:"gobekli_tepe", name:"ギョベクリ・テペ", nameEn:"Göbekli Tepe",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/G%C3%B6bekli_Tepe,_Urfa.jpg", youtubeQuery:"ギョベクリテペ 世界最古 トルコ 世界遺産", keywords:["ギョベクリテペ","トルコ","世界最古","神殿","石柱"] },
  { id:"ephesus", name:"エフェソス", nameEn:"Ephesus",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ephesus_Celsus_Library_Facade.jpg", youtubeQuery:"エフェソス トルコ ローマ 世界遺産", keywords:["エフェソス","トルコ","ローマ","ギリシャ","図書館"] },
  { id:"pamukkale", name:"ヒエラポリス＝パムッカレ", nameEn:"Hierapolis-Pamukkale",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Pamukkale_travertines.jpg", youtubeQuery:"パムッカレ 石灰棚 トルコ 世界遺産", keywords:["パムッカレ","トルコ","石灰棚","温泉","ローマ"] },
  { id:"troy", name:"トロイの考古遺跡", nameEn:"Archaeological Site of Troy",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Troy_ruins.jpg", youtubeQuery:"トロイ遺跡 トルコ イリアス 世界遺産", keywords:["トロイ","トルコ","ホメロス","シュリーマン","戦争"] },
  { id:"isfahan", name:"イスファハンのイマーム広場", nameEn:"Meidan Emam, Esfahan",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Isfahan_Imam_Mosque.jpg", youtubeQuery:"イスファハン サファヴィー朝 イラン 世界遺産", keywords:["イスファハン","イラン","サファヴィー","モスク","ペルシャ"] },
  ...
  { id:"damascus", name:"ダマスクスの旧市街", nameEn:"Ancient City of Damascus",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Umayyad_Mosque_Damascus.jpg", youtubeQuery:"ダマスカス 旧市街 シリア 世界遺産", keywords:["ダマスカス","シリア","ウマイヤ","最古","モスク"] },
  { id:"hegra", name:"ヘグラ（マダイン・サーレハ）", nameEn:"Hegra Archaeological Site",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Hegra_tomb_A1.jpg", youtubeQuery:"ヘグラ サウジアラビア ナバタイ 世界遺産", keywords:["ヘグラ","サウジアラビア","ナバタイ","岩窟","砂漠"] },
  // ══ 北米 ══
  { id:"grand_canyon", name:"グランド・キャニオン国立公園", nameEn:"Grand Canyon National Park",
    ...
    image:"https://images.unsplash.com/photo-1474044159687-1ee9f3a51722?w=400", youtubeQuery:"グランドキャニオン アメリカ 世界遺産", keywords:["グランドキャニオン","アメリカ","峡谷","コロラド川","地質"] },
  { id:"yellowstone", name:"イエローストーン国立公園", nameEn:"Yellowstone National Park",
    ...
    image:"https://images.unsplash.com/photo-1540979388789-6cee28a1cdc9?w=400", youtubeQuery:"イエローストーン 間欠泉 世界遺産", keywords:["イエローストーン","アメリカ","国立公園","間欠泉","火山"] },
  { id:"chichen_itza", name:"古代マヤ都市チチェン・イツァ", nameEn:"Pre-Hispanic City of Chichen-Itza",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"チチェンイツァ マヤ ピラミッド 世界遺産", keywords:["チチェンイツァ","メキシコ","マヤ","ピラミッド","天文"] },
  { id:"teotihuacan", name:"古代メキシコ都市テオティワカン", nameEn:"Pre-Hispanic City of Teotihuacan",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Teotihuacan_Pyramid_of_the_Sun.jpg", youtubeQuery:"テオティワカン ピラミッド メキシコ 世界遺産", keywords:["テオティワカン","メキシコ","ピラミッド","謎","古代都市"] },
  { id:"mesa_verde", name:"メサ・ヴェルデ国立公園", nameEn:"Mesa Verde National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Cliff_Palace_Mesa_Verde.jpg", youtubeQuery:"メサヴェルデ アナサジ族 世界遺産", keywords:["メサヴェルデ","アメリカ","先住民","崖住居","プエブロ"] },
  { id:"independence_hall", name:"独立記念館", nameEn:"Independence Hall",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Independence_Hall.jpg", youtubeQuery:"独立記念館 フィラデルフィア アメリカ 世界遺産", keywords:["独立記念館","アメリカ","独立宣言","民主主義","憲法"] },
  { id:"old_havana", name:"ハバナの旧市街とその要塞群", nameEn:"Old Havana and its Fortifications",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Havana_Cathedral.jpg", youtubeQuery:"ハバナ旧市街 キューバ 世界遺産", keywords:["ハバナ","キューバ","スペイン","植民地","カリブ"] },
  { id:"palenque", name:"古代マヤ都市パレンケと国立公園", nameEn:"Pre-Hispanic City and National Park of Palenque",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Palenque_temple.jpg", youtubeQuery:"パレンケ マヤ 密林 世界遺産", keywords:["パレンケ","メキシコ","マヤ","密林","石棺"] },
  // ══ 南米 ══
  { id:"machu_picchu", name:"マチュ・ピチュの歴史的保護区", nameEn:"Historic Sanctuary of Machu Picchu",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/MachuPicchu2006.jpg", youtubeQuery:"マチュピチュ インカ ペルー 世界遺産", keywords:["マチュピチュ","ペルー","インカ","空中都市","複合遺産"] },
  { id:"galapagos", name:"ガラパゴス諸島", nameEn:"Galapagos Islands",
    ...
    image:"https://images.unsplash.com/photo-1558098329-a11cff621064?w=400", youtubeQuery:"ガラパゴス 進化論 ダーウィン 世界遺産", keywords:["ガラパゴス","エクアドル","進化論","ダーウィン","固有種"] },
  { id:"iguazu", name:"イグアス国立公園", nameEn:"Iguazu National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Iguaz%C3%BA_falls_04.jpg", youtubeQuery:"イグアスの滝 アルゼンチン ブラジル 世界遺産", keywords:["イグアス","アルゼンチン","ブラジル","滝","悪魔の喉笛"] },
  { id:"easter_island", name:"ラパ・ヌイ国立公園", nameEn:"Rapa Nui National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Moai_Rano_Raraku.jpg", youtubeQuery:"イースター島 モアイ ラパヌイ 世界遺産", keywords:["イースター島","チリ","モアイ","太平洋","謎"] },
  { id:"cartagena", name:"カルタヘナの港・要塞・建造物群", nameEn:"Port, Fortresses and Group of Monuments, Cartagena",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Cartagena_Colombia_harbor.jpg", youtubeQuery:"カルタヘナ コロンビア 植民地 世界遺産", keywords:["カルタヘナ","コロンビア","スペイン","植民地","カリブ"] },
  { id:"brasilia", name:"ブラジリア", nameEn:"Brasília",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Brasilia_Cathedral_01.jpg", youtubeQuery:"ブラジリア 計画都市 世界遺産", keywords:["ブラジリア","ブラジル","計画都市","ニーマイヤー","近代"] },
  { id:"chan_chan", name:"チャン・チャン遺跡地帯", nameEn:"Chan Chan Archaeological Zone",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Chan_Chan_ruins.jpg", youtubeQuery:"チャンチャン チムー ペルー 世界遺産", keywords:["チャンチャン","ペルー","チムー","日干しレンガ","インカ以前"] },
  // ══ オセアニア ══
  { id:"great_barrier_reef", name:"グレート・バリア・リーフ", nameEn:"Great Barrier Reef",
    ...
    image:"https://images.unsplash.com/photo-1582967788606-a171c1080cb0?w=400", youtubeQuery:"グレートバリアリーフ サンゴ礁 オーストラリア 世界遺産", keywords:["グレートバリアリーフ","オーストラリア","サンゴ礁","温暖化","白化"] },
  { id:"sydney_opera", name:"シドニー・オペラハウス", nameEn:"Sydney Opera House",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Sydney_Opera_House_-_Dec_2008.jpg", youtubeQuery:"シドニーオペラハウス 世界遺産", keywords:["シドニー","オペラハウス","オーストラリア","近代建築","デンマーク"] },
  { id:"uluru", name:"ウルル、カタ・ジュタ国立公園", nameEn:"Uluṟu-Kata Tjuṯa National Park",
    ...
    image:"https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?w=400", youtubeQuery:"ウルル エアーズロック オーストラリア 世界遺産", keywords:["ウルル","エアーズロック","オーストラリア","アボリジニ","複合遺産"] },
  { id:"tongariro", name:"トンガリロ国立公園", nameEn:"Tongariro National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Tongariro_National_Park.jpg", youtubeQuery:"トンガリロ 火山 ニュージーランド 世界遺産", keywords:["トンガリロ","ニュージーランド","マオリ","火山","指輪物語"] },
  { id:"kakadu", name:"カカドゥ国立公園", nameEn:"Kakadu National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Kakadu_National_Park.jpg", youtubeQuery:"カカドゥ アボリジニ 岩絵 オーストラリア 世界遺産", keywords:["カカドゥ","オーストラリア","アボリジニ","岩絵","湿地"] }
];
