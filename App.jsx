...
const worldHeritageDataPart1 = [
  ...
  { id:"rome", name:"ローマ歴史地区", nameEn:"Historic Centre of Rome",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Colosseum_in_Rome-April_2007-1-_copie_2B.jpg",
  ...
  { id:"venice", name:"ヴェネツィアとその潟", nameEn:"Venice and its Lagoon",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Piazza_San_Marco_with_the_Basilica_of_Saint_Mark_-_2012.jpg",
  ...
  { id:"florence", name:"フィレンツェ歴史地区", nameEn:"Historic Centre of Florence",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Firenze_veduta.jpg",
  ...
  { id:"pompeii", name:"ポンペイ・エルコラーノ・トッレ・アンヌンツィアータの考古地域",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Pompeii_amphitheatre.jpg",
  ...
  { id:"pisa", name:"ピサのドゥオーモ広場", nameEn:"Piazza del Duomo, Pisa",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Leaning_Tower_of_Pisa_%28dsc03884%29.jpg",
  ...
  { id:"amalfi", name:"アマルフィ海岸", nameEn:"Costiera Amalfitana",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Amalfi_Coast_2013.jpg",
  ...
  { id:"versailles", name:"ヴェルサイユの宮殿と庭園",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Versailles_2008_N2.jpg",
  ...
  { id:"mont_saint_michel", name:"モン・サン＝ミシェルとその湾",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Mont_Saint-Michel_at_night.jpg",
  ...
  { id:"chartres", name:"シャルトル大聖堂", nameEn:"Chartres Cathedral",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Cathedrale.chartres.800px.jpg",
  ...
  { id:"avignon", name:"アヴィニョン歴史地区―教皇宮殿・司教建造物群及びアヴィニョン橋",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Pont_Saint-B%C3%A9n%C3%A9zet2.jpg",
  ...
  { id:"alhambra", name:"グラナダのアルハンブラ、ヘネラリーフェ、アルバイシン地区",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Front_view_of_Patio_de_los_Leones.jpg",
  ...
  { id:"burgos", name:"ブルゴスの大聖堂", nameEn:"Burgos Cathedral",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Burgos_-_Catedral_-_20110904_101318.jpg",
  ...
  { id:"stonehenge", name:"ストーンヘンジ、エーヴベリーと関連する遺跡群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Stonehenge2007_07_30.jpg",
  ...
  { id:"tower_of_london", name:"ロンドン塔", nameEn:"Tower of London",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/TOL_white_tower.jpg",
  ...
  { id:"ironbridge", name:"アイアンブリッジ渓谷", nameEn:"Ironbridge Gorge",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ironbridge_-_Shropshire.jpg",
  ...
  { id:"westminster", name:"ウェストミンスター宮殿、ウェストミンスター寺院及び聖マーガレット教会",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Westminster_Abbey_Exterior%2C_London%2C_UK_-_Diliff.jpg",
  ...
  { id:"cologne", name:"ケルン大聖堂", nameEn:"Cologne Cathedral",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Koelner_Dom_Alter_Markt.jpg",
  ...
  { id:"potsdam", name:"ポツダムとベルリンの宮殿群と公園群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Sanssouci_building.jpg",
  ...
  { id:"auschwitz", name:"アウシュビッツ・ビルケナウ ナチス・ドイツの強制・絶滅収容所",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Auschwitz_I_Gate.jpg",
  ...
  { id:"acropolis", name:"アテネのアクロポリス", nameEn:"Acropolis, Athens",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Parthenon_Athens_Jan_2006.jpg",
  ...
  { id:"delphi", name:"デルフィの聖域", nameEn:"Archaeological Site of Delphi",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Temple_of_Apollo_at_Delphi_-_Greece.jpg",
  ...
  { id:"budapest", name:"ブダペストのドナウ河岸地域", nameEn:"Budapest, including the Banks of the Danube",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Budapest_-_Hungarian_Parliament_building.jpg",
  ...
  { id:"prague", name:"プラハ歴史地区", nameEn:"Historic Centre of Prague",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Prague_-_Old_Town_Square.jpg",
  ...
  { id:"vienna", name:"ウィーン歴史地区", nameEn:"Historic Centre of Vienna",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Kunsthistorisches_Museum_Wien_2014_%28cropped%29.jpg",
  ...
  { id:"hallstatt", name:"ハルシュタット・ダッハシュタイン・ザルツカンマーグート文化的景観",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Hallstatt_2013.jpg",
  ...
  { id:"st_petersburg", name:"サンクト・ペテルブルグ歴史地区と関連建造物群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Hermitage_museum.jpg",
  ...
  { id:"kremlin", name:"モスクワのクレムリンと赤の広場",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Moscow_July_2011-14.jpg",
  ...
  { id:"tallinn", name:"タリン歴史地区（旧市街）", nameEn:"Historic Centre (Old Town) of Tallinn",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Tallinn_vanalinn.jpg",
  ...
  { id:"krakow", name:"クラクフ歴史地区", nameEn:"Cracow's Historic Centre",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Rynek_Glowny_z_lotu_ptaka.jpg",
  ...
  { id:"amsterdam", name:"アムステルダムの17世紀環状運河地域",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Amsterdam_Jordaan.jpg",
  ...
  { id:"blenheim", name:"ブレナム宮殿", nameEn:"Blenheim Palace",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Blenheim_Palace_from_the_south.jpg",
  ...
  { id:"forbidden_city", name:"北京と瀋陽の明・清朝の皇宮群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Forbidden_City_1.jpg",
  ...
  { id:"terracotta", name:"秦の始皇帝陵と兵馬俑坑",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Terracotta_Army_-_Battle_Formations.jpg",
  ...
  { id:"potala", name:"ラサのポタラ宮の歴史的遺跡群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Potala_palace_inner.jpg",
  ...
  { id:"taj_mahal", name:"タージ・マハル", nameEn:"Taj Mahal",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Taj_Mahal%2C_Agra%2C_India_edit3.jpg",
  ...
  { id:"ajanta", name:"アジャンタ石窟群", nameEn:"Ajanta Caves",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ajanta_cave9.jpg",
  ...
  { id:"angkor", name:"アンコール遺跡", nameEn:"Angkor",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Angkor_Wat%2C_Camboda.jpg",
  ...
  { id:"borobudur", name:"ボロブドゥール寺院遺跡群",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Borobudur-Nothwest-view.jpg",
  ...
  { id:"halong_bay", name:"ハロン湾", nameEn:"Ha Long Bay",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Halong_Bay_-_panoramio_%282%29.jpg",
  ...
  { id:"petra", name:"ペトラ", nameEn:"Petra",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Treasury_petra_crop.jpg",
  ...
  { id:"jerusalem", name:"エルサレムの旧市街とその城壁",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Mount_of_olives_and_old_city_of_jerusalem.jpg",
...
const japanHeritageData = [
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Horyu-ji_National_Treasure_World_heritage003.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Himeji_Castle_The_Keep_Towers.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Yakusugi_Land_02.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Shirakami-Sanchi_1.JPG",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ogimachi-Gassho-Shirakawa.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Hiroshima_Peace_Memorial-0006.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Itsukushima_Shrine_2019-11-02.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Todaiji18s3200.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Yomeimon_2014.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Shuri-jo_Naha_Okinawa_Japan.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Nachi_falls.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Shiretoko_National_Park_01.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Chuson-ji_Konjikido.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ogasawara_Islands.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Fuji_from_Shinkansen_N3.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Hashima_island.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Okinoshima_Island_aerial_photo.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Ikitsuki-shimabara.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Daisen_Kofun_aerial_photograph_2016.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Amami_Oshima_Island.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Sannai-Maruyama_site07s3200.jpg",
  ...
  },
  {
    ...
    image: "https://commons.wikimedia.org/wiki/Special:FilePath/Sado_gold_mine_2.jpg",
...
const worldHeritageDataPart2 = [
  ...
  { id:"pyramids", name:"メンフィスとその墓地遺跡", nameEn:"Memphis and its Necropolis",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Kheops-Pyramid.jpg", youtubeQuery:"ギザ ピラミッド 世界遺産", keywords:["ピラミッド","エジプト","古代","スフィンクス","七不思議"] },
  ...
  { id:"goree", name:"ゴレ島", nameEn:"Island of Gorée",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Goree_Island_Senegal.jpg", youtubeQuery:"ゴレ島 奴隷 セネガル 世界遺産", keywords:["ゴレ島","奴隷","セネガル","負の遺産","大西洋"] },
  ...
  { id:"victoria_falls", name:"モシ・オ・トゥニャ/ヴィクトリアの滝", nameEn:"Mosi-oa-Tunya / Victoria Falls",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Victoria_Falls_-_2012-05-01_-_7.jpg", youtubeQuery:"ヴィクトリア滝 アフリカ 世界遺産", keywords:["ヴィクトリア滝","アフリカ","滝","ザンビア","ジンバブエ"] },
  ...
  { id:"grand_canyon", name:"グランド・キャニオン国立公園", nameEn:"Grand Canyon National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Dawn_on_the_S_rim_of_the_Grand_Canyon_%288645178272%29.jpg", youtubeQuery:"グランドキャニオン アメリカ 世界遺産", keywords:["グランドキャニオン","アメリカ","峡谷","コロラド川","地質"] },
  { id:"yellowstone", name:"イエローストーン国立公園", nameEn:"Yellowstone National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Geyser_in_Yellowstone.jpg", youtubeQuery:"イエローストーン 間欠泉 世界遺産", keywords:["イエローストーン","アメリカ","国立公園","間欠泉","火山"] },
  { id:"chichen_itza", name:"古代マヤ都市チチェン・イツァ", nameEn:"Pre-Hispanic City of Chichen-Itza",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Chichen_Itza_3.jpg", youtubeQuery:"チチェンイツァ マヤ ピラミッド 世界遺産", keywords:["チチェンイツァ","メキシコ","マヤ","ピラミッド","天文"] },
  ...
  { id:"galapagos", name:"ガラパゴス諸島", nameEn:"Galapagos Islands",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Galapagos_islands.jpg", youtubeQuery:"ガラパゴス 進化論 ダーウィン 世界遺産", keywords:["ガラパゴス","エクアドル","進化論","ダーウィン","固有種"] },
  ...
  { id:"great_barrier_reef", name:"グレート・バリア・リーフ", nameEn:"Great Barrier Reef",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Great_Barrier_Reef_Marine_Park.jpg", youtubeQuery:"グレートバリアリーフ サンゴ礁 オーストラリア 世界遺産", keywords:["グレートバリアリーフ","オーストラリア","サンゴ礁","温暖化","白化"] },
  ...
  { id:"uluru", name:"ウルル、カタ・ジュタ国立公園", nameEn:"Uluṟu-Kata Tjuṯa National Park",
    ...
    image:"https://commons.wikimedia.org/wiki/Special:FilePath/Uluru_morning.jpg", youtubeQuery:"ウルル エアーズロック オーストラリア 世界遺産", keywords:["ウルル","エアーズロック","オーストラリア","アボリジニ","複合遺産"] },
