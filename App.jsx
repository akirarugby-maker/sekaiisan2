...
const worldHeritageDataPart2 = [
  ...
  { id:"abu_simbel", name:"ヌビアの遺跡群－アブ・シンベルからフィラエまで", nameEn:"Nubian Monuments from Abu Simbel to Philae",
    ...
    image:"https://images.unsplash.com/photo-1539650116574-8efeb43e2750?w=400", youtubeQuery:"アブシンベル ラムセス2世 世界遺産", keywords:["アブシンベル","エジプト","ラムセス","移設","ヌビア"] },
  ...
  { id:"timbuktu", name:"ティンブクトゥ", nameEn:"Timbuktu",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ティンブクトゥ マリ 砂漠 世界遺産", keywords:["ティンブクトゥ","マリ","砂漠","イスラム","交易"] },
  { id:"great_zimbabwe", name:"グレート・ジンバブエの遺跡", nameEn:"Great Zimbabwe National Monument",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"グレートジンバブエ 石造 世界遺産", keywords:["ジンバブエ","石造","ショナ","アフリカ","城塞"] },
  ...
  { id:"serengeti", name:"セレンゲティ国立公園", nameEn:"Serengeti National Park",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"セレンゲティ ヌーの大移動 タンザニア 世界遺産", keywords:["セレンゲティ","タンザニア","ヌー","大移動","サバンナ"] },
  { id:"ngorongoro", name:"ンゴロンゴロ保全地域", nameEn:"Ngorongoro Conservation Area",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ンゴロンゴロ カルデラ タンザニア 世界遺産", keywords:["ンゴロンゴロ","カルデラ","タンザニア","人類化石","野生動物"] },
  { id:"lalibela", name:"ラリベラの岩窟教会群", nameEn:"Rock-Hewn Churches, Lalibela",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ラリベラ 岩窟教会 エチオピア 世界遺産", keywords:["ラリベラ","エチオピア","岩窟教会","キリスト教","中世"] },
  { id:"robben_island", name:"ロベン島", nameEn:"Robben Island",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ロベン島 マンデラ アパルトヘイト 世界遺産", keywords:["ロベン島","南アフリカ","マンデラ","アパルトヘイト","島"] },
  { id:"kilimanjaro", name:"キリマンジャロ国立公園", nameEn:"Kilimanjaro National Park",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"キリマンジャロ アフリカ最高峰 世界遺産", keywords:["キリマンジャロ","タンザニア","アフリカ最高峰","火山","雪"] },
  { id:"okavango", name:"オカバンゴ・デルタ", nameEn:"Okavango Delta",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"オカバンゴ デルタ ボツワナ 世界遺産", keywords:["オカバンゴ","ボツワナ","デルタ","野生動物","象"] },
  { id:"djenne", name:"ジェンネの旧市街", nameEn:"Old Towns of Djenné",
    ...
    image:"https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400", youtubeQuery:"ジェンネ 泥モスク マリ 世界遺産", keywords:["ジェンネ","マリ","泥建築","モスク","イスラム"] },
  // ══ 中東 ══
  { id:"gobekli_tepe", name:"ギョベクリ・テペ", nameEn:"Göbekli Tepe",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"ギョベクリテペ 世界最古 トルコ 世界遺産", keywords:["ギョベクリテペ","トルコ","世界最古","神殿","石柱"] },
  { id:"ephesus", name:"エフェソス", nameEn:"Ephesus",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"エフェソス トルコ ローマ 世界遺産", keywords:["エフェソス","トルコ","ローマ","ギリシャ","図書館"] },
  { id:"pamukkale", name:"ヒエラポリス＝パムッカレ", nameEn:"Hierapolis-Pamukkale",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"パムッカレ 石灰棚 トルコ 世界遺産", keywords:["パムッカレ","トルコ","石灰棚","温泉","ローマ"] },
  { id:"troy", name:"トロイの考古遺跡", nameEn:"Archaeological Site of Troy",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"トロイ遺跡 トルコ イリアス 世界遺産", keywords:["トロイ","トルコ","ホメロス","シュリーマン","戦争"] },
  { id:"isfahan", name:"イスファハンのイマーム広場", nameEn:"Meidan Emam, Esfahan",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"イスファハン サファヴィー朝 イラン 世界遺産", keywords:["イスファハン","イラン","サファヴィー","モスク","ペルシャ"] },
  { id:"babylon", name:"バビロン", nameEn:"Babylon",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"バビロン メソポタミア イラク 世界遺産", keywords:["バビロン","イラク","メソポタミア","ハンムラビ","古代"] },
  { id:"damascus", name:"ダマスクスの旧市街", nameEn:"Ancient City of Damascus",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"ダマスカス 旧市街 シリア 世界遺産", keywords:["ダマスカス","シリア","ウマイヤ","最古","モスク"] },
  { id:"hegra", name:"ヘグラ（マダイン・サーレハ）", nameEn:"Hegra Archaeological Site",
    ...
    image:"https://images.unsplash.com/photo-1548019979-ba7fcaef4b55?w=400", youtubeQuery:"ヘグラ サウジアラビア ナバタイ 世界遺産", keywords:["ヘグラ","サウジアラビア","ナバタイ","岩窟","砂漠"] },
  // ══ 北米 ══
  ...
  { id:"teotihuacan", name:"古代メキシコ都市テオティワカン", nameEn:"Pre-Hispanic City of Teotihuacan",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"テオティワカン ピラミッド メキシコ 世界遺産", keywords:["テオティワカン","メキシコ","ピラミッド","謎","古代都市"] },
  { id:"mesa_verde", name:"メサ・ヴェルデ国立公園", nameEn:"Mesa Verde National Park",
    ...
    image:"https://images.unsplash.com/photo-1474044159687-1ee9f3a51722?w=400", youtubeQuery:"メサヴェルデ アナサジ族 世界遺産", keywords:["メサヴェルデ","アメリカ","先住民","崖住居","プエブロ"] },
  { id:"independence_hall", name:"独立記念館", nameEn:"Independence Hall",
    ...
    image:"https://images.unsplash.com/photo-1474044159687-1ee9f3a51722?w=400", youtubeQuery:"独立記念館 フィラデルフィア アメリカ 世界遺産", keywords:["独立記念館","アメリカ","独立宣言","民主主義","憲法"] },
  { id:"old_havana", name:"ハバナの旧市街とその要塞群", nameEn:"Old Havana and its Fortifications",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"ハバナ旧市街 キューバ 世界遺産", keywords:["ハバナ","キューバ","スペイン","植民地","カリブ"] },
  { id:"palenque", name:"古代マヤ都市パレンケと国立公園", nameEn:"Pre-Hispanic City and National Park of Palenque",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"パレンケ マヤ 密林 世界遺産", keywords:["パレンケ","メキシコ","マヤ","密林","石棺"] },
  // ══ 南米 ══
  { id:"machu_picchu", name:"マチュ・ピチュの歴史的保護区", nameEn:"Historic Sanctuary of Machu Picchu",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"マチュピチュ インカ ペルー 世界遺産", keywords:["マチュピチュ","ペルー","インカ","空中都市","複合遺産"] },
  ...
  { id:"iguazu", name:"イグアス国立公園", nameEn:"Iguazu National Park",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"イグアスの滝 アルゼンチン ブラジル 世界遺産", keywords:["イグアス","アルゼンチン","ブラジル","滝","悪魔の喉笛"] },
  { id:"easter_island", name:"ラパ・ヌイ国立公園", nameEn:"Rapa Nui National Park",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"イースター島 モアイ ラパヌイ 世界遺産", keywords:["イースター島","チリ","モアイ","太平洋","謎"] },
  { id:"cartagena", name:"カルタヘナの港・要塞・建造物群", nameEn:"Port, Fortresses and Group of Monuments, Cartagena",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"カルタヘナ コロンビア 植民地 世界遺産", keywords:["カルタヘナ","コロンビア","スペイン","植民地","カリブ"] },
  { id:"brasilia", name:"ブラジリア", nameEn:"Brasília",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"ブラジリア 計画都市 世界遺産", keywords:["ブラジリア","ブラジル","計画都市","ニーマイヤー","近代"] },
  { id:"chan_chan", name:"チャン・チャン遺跡地帯", nameEn:"Chan Chan Archaeological Zone",
    ...
    image:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400", youtubeQuery:"チャンチャン チムー ペルー 世界遺産", keywords:["チャンチャン","ペルー","チムー","日干しレンガ","インカ以前"] },
  // ══ オセアニア ══
  ...
  { id:"sydney_opera", name:"シドニー・オペラハウス", nameEn:"Sydney Opera House",
    ...
    image:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400", youtubeQuery:"シドニーオペラハウス 世界遺産", keywords:["シドニー","オペラハウス","オーストラリア","近代建築","デンマーク"] },
  ...
  { id:"tongariro", name:"トンガリロ国立公園", nameEn:"Tongariro National Park",
    ...
    image:"https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?w=400", youtubeQuery:"トンガリロ 火山 ニュージーランド 世界遺産", keywords:["トンガリロ","ニュージーランド","マオリ","火山","指輪物語"] },
  { id:"kakadu", name:"カカドゥ国立公園", nameEn:"Kakadu National Park",
    ...
    image:"https://images.unsplash.com/photo-1529108190281-9a4f620bc2d8?w=400", youtubeQuery:"カカドゥ アボリジニ 岩絵 オーストラリア 世界遺産", keywords:["カカドゥ","オーストラリア","アボリジニ","岩絵","湿地"] }
];
